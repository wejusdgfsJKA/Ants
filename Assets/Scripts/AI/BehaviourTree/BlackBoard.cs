...
public interface IBlackBoard
{
    ...
    public void AddListener<T>(Action action, string key);
    public void RemoveListener(Action action, string key);
}
public class BlackBoard : IBlackBoard
{
    /// <summary>
    /// This is a wrapper for a resource which other scripts can keep track of.
    /// </summary>
    public class Data
    {
    ...
    public void AddListener<T>(Action action, string key)
    {
        ...
        {
            var d = new Data(default(T));
            d.OnValueChanged += action;
            data.Add(key, d);
        }
    }
    /// <summary>
